...
public class ViewAllBorrowedBooks {
    ...
    public Node getView() {
        ...
        container.setStyle("-fx-background-color: linear-gradient(to bottom, #e0f7fa, #ffffff);");
	...
	private void setupTableColumns() {
        TableColumn<BorrowedBookRecord, String> usernameCol = new TableColumn<>("Username");
        ...
        tableView.getColumns().addAll(usernameCol, bookTitleCol, borrowDateCol, dueDateCol, overdueCol);
    }
